  ...
  return (
    <div className="pl-28 pt-8">
      ...
      <div>
        ...
        {/* Basic Info */}
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-emerald-900 mb-2">基本信息</h3>
          <div className="grid grid-cols-2 gap-5 text-emerald-900">
        ...
        {/* Base Attributes */}
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-emerald-900 mb-2">基础属性</h3>
        ...
        {/* Derived Attributes */}
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-emerald-900 mb-2">派生属性</h3>
          <div className="grid grid-cols-3 gap-3 text-emerald-900">
        ...
        {/* Skills */}
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-emerald-900 mb-2">技能</h3>
          <div className="grid grid-cols-3 gap-3 text-emerald-900">
